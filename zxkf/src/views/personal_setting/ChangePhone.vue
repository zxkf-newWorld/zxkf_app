  ...
  <div class="change-phone">
    ...
    <main class="setting-body">
      <div class="pwd">
        ...
        <span>
          <mt-field
            ...
            v-model="password"
            placeholder="密码"
            :attr="{autofocus:true, maxlength: 10}"
          ></mt-field>
        </span>
      ...
      <div class="phone">
        <span class="iconfont">&#xe64b;</span>
        <span>
          <mt-field type="phone" :attr="{maxlength:11}" v-model="phone" placeholder="新手机号"></mt-field>
        </span>
...
export default {
  ...
  methods: {
    ...
    reserve() {
      ...
      this.axios
        .post(url, /* this.qs.stringify(formdata) */ formdata)
        .then(result => {
